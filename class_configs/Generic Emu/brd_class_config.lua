...
local _ClassConfig = {
    ...
    ['ModeChecks']      = {
        ...
        IsMezzing  = function() return Config:GetSetting('UseSingleTgtMez') end,
    ...
    ['AbilitySets']     = {
        ...
        ['InsultSong'] = {
            ...
            "Bellow of Chaos",           --66, interrupt (pushback)
    ...
    ['DefaultConfig']   = {
        ...
        ['UseRunBuff']          = {
            ...
            Type = "Combo",
            ComboOptions = { 'Song (Long Duration Only)', 'Song (Fastest Available)', 'Off', },
            Default = 1,
            Min = 1,
            Max = 4,
            RequiresLoadoutChange = true,
