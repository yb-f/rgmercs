...
local _ClassConfig = {
    ...
    ['HelperFunctions'] = {
        ...
        DiscOverwriteCheck = function(self)
            if mq.TLO.Me.ActiveDisc.ID() then return false end
            return true
        end,
        BurnDiscCheck = function(self)
            ...
            local burnDisc = { "Onslaught", "MightyStrike", "ChargeDisc", }
    ...
    ['Rotations']       = {
        ...
        ['Defenses'] = {
            ...
            { --shares effect with OoW Chest and Warlord's Bravery, offset from AbsorbDisc for automation flow/coverage
                ...
                type = "Disc",
                cond = function(self, discSpell)
                    return Casting.DiscReady(discSpell) and self.ClassConfig.HelperFunctions.DiscOverwriteCheck(self)
                end,
            },
            { --shares effect with StandDisc and Warlord's Bravery, offset from AbsorbDisc for automation flow/coverage
                ...
                cond = function(self, itemName)
                    ...
                    return mq.TLO.FindItemCount(itemName)() ~= 0 and mq.TLO.FindItem(itemName).TimerReady() == 0 and mq.TLO.Me.ActiveDisc.Name() ~= standDisc.RankName()
                end,
            },
